...
Після зміни прав доступу і типу володіння,відкрити файл для читання і щось у нього записати неможливо
...
Програма виконує команду ls -l, для перегляду власника і права доступу до файлів у домашньому каталозі, в /usr/bin та в /etc
